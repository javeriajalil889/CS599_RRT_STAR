...
from rrt_algorithms.rrt.heuristics import cost_to_go, segment_cost, path_cost
from rrt_algorithms.rrt.rrt import RRT
from rrt_algorithms.search_space.search_space_2d import SearchSpace
import time
    ...
    def rrt_star(self):
        ...
        while True:
            ...
            if solution[0]:
                ...
                print("RRT total execution time:", end - start)
                return solution[1]


def main():
    X_dimensions = [(0, 100), (0, 100)]
    obstacles = [
        (20, 20, 40, 40),
        (60, 60, 80, 80)
    ]
    ...
    rrt = RRTStar(X, q, x_init, x_goal, max_samples, r)
    path = rrt.rrt_star()
